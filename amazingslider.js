    ...
    $.fn.ashtml5lightbox = function(options) {
        ...
        inst.createMarkup = function() {
            ...
            if (inst.options.fullscreenmode) {
                ...
                inst.$elemWrap.append("<div id='html5-next' style='display:none;cursor:pointer;position:absolute;right:" + inst.options.bordersize + "px;top:50%;margin-top:-16px;'><img alt='' src='" + inst.options.nextimage + "'></div>" + "<div id='html5-prev' style='display:none;cursor:pointer;position:absolute;left:" + inst.options.bordersize + "px;top:50%;margin-top:-16px;'><img alt='' src='" + inst.options.previmage + "'></div>");
        ...
        inst.showTitle = function(w, t, description) {
            ...
            if (inst.options.inGroup) {
                ...
                if (inst.options.showplaybutton)
                    text = "<div id='html5-playpause' style='display:inline-block;cursor:pointer;vertical-align:middle;'><div id='html5-play' style='display:block;'><img alt='' src='" + inst.options.playimage + "'></div><div id='html5-pause' style='display:none;'><img alt='' src='" + inst.options.pauseimage + "'></div></div> " + text
            }
            if (text.length > 0)
        ...
        inst.showImage = function(elem, imgW, imgH) {
            ...
            inst.resizeLightbox(sizeObj.w, sizeObj.h, true, function() {
                ...
                inst.$image.show();
                inst.$image.html("<div id='html5-image-container' style='display:block;position:relative;width:100%;height:100%;" + (inst.options.imagekeepratio ? "overflow:hidden;" : "overflow:auto;") + "'><img alt='" + elem[ELEM_TITLE] + "' src='" + elem[ELEM_HREF] + "' width='100%' height='" + (inst.options.imagekeepratio ? "100%" : "auto") + "' />" + timercode + "</div>");
                inst.$elem.fadeIn(inst.options.fadespeed, function() {
                    inst.showData()
                });
                if (inst.autosliding) {
    ...
    $.fn.amazingslider = function(options) {
        ...
        AmazingSlider.prototype = {
            ...
            readTags: function() {
                ...
                $(".amazingslider-slides", this.container).find("li").each(function() {
                    ...
                    if (img.length > 0) {
                        ...
                        if (!title && instance.options.titleusealt)
                            title = img.attr("alt") && img.attr("alt").length > 0 ? img.attr("alt") : "";
            ...
            init: function(instance) {
                ...
                if (!isNaN(paramValue) && paramValue >= 0 && paramValue < instance.elemArray.length)
                    firstSlide = paramValue;
            ...
            createWm: function() {
                ...
                if (this.options.watermarkstyle == "text")
                    ...
                    if (watermarkimage.substring(0, 7).toLowerCase() != "http://" && watermarkimage.substring(0, 8).toLowerCase() != "https://")
                        watermarkimage = this.options.skinsfolder + watermarkimage;
            ...
            showSocial: function() {
                ...
                if (this.options.showfacebook)
                    socialCode += '<div class="amazingslider-social-btn' + (this.options.socialrotateeffect ? " amazingslider-rotate" : "") + ' amazingslider-social-facebook" style="' + socialBtnCSS + '"><div class="mh-icon-facebook" style="' + socialCSS + 'background-color:#3b5998;"></div></div>';
                if (this.options.showtwitter)
                    socialCode += '<div class="amazingslider-social-btn' + (this.options.socialrotateeffect ? " amazingslider-rotate" : "") + ' amazingslider-social-twitter" style="' + socialBtnCSS + '"><div class="mh-icon-twitter" style="' + socialCSS + 'background-color:#03b3ee;"></div></div>';
                if (this.options.showpinterest)
                    socialCode += '<div class="amazingslider-social-btn' + (this.options.socialrotateeffect ? " amazingslider-rotate" : "") + ' amazingslider-social-pinterest" style="' + socialBtnCSS + '"><div class="mh-icon-pinterest" style="' + socialCSS + 'background-color:#c92228;"></div></div>';
                socialCode += '<div style="clear:both;"></div></div>';
                ...
                $(".amazingslider-social-btn", this.container).click(function() {
                    ...
                    if ($(this).hasClass("amazingslider-social-facebook"))
                        window.open("https://www.facebook.com/sharer/sharer.php?u=" + encodeURIComponent(shareUrl) + "&t=" + encodeURIComponent(shareTitle), "_blank");
                    else if ($(this).hasClass("amazingslider-social-twitter"))
                        window.open("https://twitter.com/share?url=" + encodeURIComponent(shareUrl) + "&text=" + encodeURIComponent(shareTitle), "_blank");
            ...
            playVideo: function(autoplay) {
                ...
                if (type == TYPE_VIDEO_YOUTUBE)
                    ...
                    this.playIframeVideo(href, autoplay)
            },
            playMp4Video: function(href, webmhref, autoplay) {
                ...
                if (this.options.forceflash && ASPlatforms.flashInstalled())
                    isHTML5 = false;
                if (!ASPlatforms.html5VideoSupported())
                    isHTML5 = false;
                if (ASPlatforms.isIE6789())
                    isHTML5 = false;
                if (ASPlatforms.isFirefox() || ASPlatforms.isOpera())
                    if (!ASPlatforms.canPlayMP4() && !webmhref)
                        isHTML5 = false;
                if (ASPlatforms.isIE10() && this.options.forceflashonie10 || ASPlatforms.isIE11() && this.options.forceflashonie11)
                    isHTML5 = false;
                if (isHTML5) {
                    var videoSrc = href;
                    if (ASPlatforms.isFirefox() || ASPlatforms.isOpera())
            ...
            embedHTML5Video: function($container, src, autoPlay) {
                ...
                if (ASPlatforms.isFirefox() && this.options.nativecontrolsonfirefox)
                    nativecontrols = true;
                if (!nativecontrols)
                    $("video", $container).asHTML5VideoControls(this.options.skinsfolder, this, this.options.videohidecontrols, this.options.videohideplaybutton, this.options.defaultvideovolume);
                var instance = this;
                $("video", $container).off("ended").on("ended", function() {
                    instance.videoPaused = false;
                    if (!instance.isPaused)
            ...
            createText: function() {
                ...
                this.container.on("amazingslider.switchtext", function(event, prev, cur) {
                    ...
                    if (instance.textoptions.texteffectresponsive)
                        textHeadCss += "@media (max-width: " + instance.textoptions.texteffectresponsivesize + "px) {" + ".amazingslider-title-" + instance.id + " {" + instance.textoptions.titlecssresponsive + "} " + ".amazingslider-description-" + instance.id + " {" + instance.textoptions.descriptioncssresponsive + "} " + ".amazingslider-button-" + instance.id + " {" + instance.textoptions.buttoncssresponsive + "} " + "} ";
                    textHeadCss += "</style>";
            ...
            resizeSlider: function() {
                ...
                if (this.options.width % 2 !== 0 && this.options.forcewidthtoevenforslice)
                    if (this.options.increasewhenforcetoeven)
                        this.options.width++;
                    else
                        this.options.width--;
                if (this.options.isfullscreen) {
                    ...
                    if (this.options.scalemode == "flexheight")
                        this.options.height = this.options.width * this.options.flexratio;
                    else
                ...
                if (this.options.navmultirows && this.options.navdirection == "horizontal" && this.options.navthumbresponsivemode == "samecolumn") {
                    ...
                    for (var i = 1; i < $bullets.length; i++)
                        if ((i + 1) % this.options.navthumbcolumn == 0)
                            $bullets.eq(i).css({
                                "margin-right": 0
                            });
                        else
                ...
                if (this.options.navthumbnavigationstyle != "auto") {
                    if (this.options.navmultirows) {
                        if (this.options.navdirection == "horizontal") {
                            ...
                            if (this.options.navthumbresponsivemode == "samecolumn")
                                m = 0;
                            $navContainer.css({
                                width: "100%",
                                "margin-left": m + "px"
                    ...
                    if (this.options.navstyle == "thumbnails" && this.options.navthumbresponsive) {
                        ...
                        if (this.options.navposition == "bottomleft" || this.options.navposition == "bottomright" || this.options.navposition == "bottom" || this.options.navposition == "right")
                            p += bulletPos;
                        if (this.options.navdirection == "vertical") {
                            $carLeftArrow.css({
            ...
            createNav: function() {
                ...
                if (this.options.navstyle == "thumbnails") {
                    if (this.options.navthumbresponsive || this.options.navthumbresponsivemode == "samecolumn")
                ...
                if (this.options.navstyle != "none") {
                    ...
                    if (instance.options.navmultirows && instance.options.navdirection == "horizontal" && instance.options.navthumbresponsivemode == "samecolumn") {
                        ...
                        for (var i = 1; i < $bullets.length; i++)
                            if ((i + 1) % instance.options.navthumbcolumn == 0)
                                $bullets.eq(i).css({
                                    "margin-right": 0
                                });
                            else
                    ...
                    if (instance.options.navthumbnavigationstyle == "auto")
                        ...
                        if (instance.options.navmultirows && instance.options.navdirection == "horizontal") {
                            ...
                            if (instance.options.navthumbresponsivemode == "samecolumn")
                                m = 0;
                            $navContainer.css({
                                width: "100%",
                                "margin-left": m + "px"
                    ...
                    if (this.options.navshowfeaturedarrow)
                        $bulletWrapper.append("<div class='amazingslider-nav-featuredarrow-" + this.id + "' style='display:none;position:absolute;width:" + this.options.navfeaturedarrowimagewidth + "px;" + "height:" + this.options.navfeaturedarrowimageheight + "px;" + 'background:url("' + this.options.navfeaturedarrowimage + "\") no-repeat center center;'></div>")
                }
                if (this.options.navshowbuttons) {
                ...
                $bullet.hover(function() {
                    ...
                    if (instance.options.navshowpreview) {
                        ...
                        if (instance.options.navshowplayvideo) {
                            ...
                            if (instance.elemArray[bulletIndex][ELEM_VIDEO].length > 0 || instance.elemArray[bulletIndex][ELEM_LINK] && instance.elemArray[bulletIndex][ELEM_LIGHTBOX] && instance.elemArray[bulletIndex][ELEM_VIDEOTYPE] > 0)
                                $previewPlay.show();
                            else
                                $previewPlay.hide()
                        }
                        ...
                        $(imgLoader).on("load", function() {
                            ...
                            if (instance.options.navdirection == "vertical") {
                                var $curImg = $("<div class='amazingslider-nav-preview-img-" + instance.id + "' style='display:block;position:absolute;overflow:hidden;width:" + instance.options.navpreviewwidth + "px;height:" + instance.options.navpreviewheight + "px;left:0px;top:" + instance.options.navpreviewheight + "px;'><img alt='" + instance.elemArray[bulletIndex][ELEM_ALT] + "' src='" + instance.elemArray[bulletIndex][ELEM_THUMBNAIL] + "' style='display:block;position:absolute;left:0px;top:0px;" + style + "' /></div>");
                                ...
                                var $curImg = $("<div class='amazingslider-nav-preview-img-" + instance.id + "' style='display:block;position:absolute;overflow:hidden;width:" + instance.options.navpreviewwidth + "px;height:" + instance.options.navpreviewheight + "px;left:" + instance.options.navpreviewheight + "px;top:0px;'><img alt='" + instance.elemArray[bulletIndex][ELEM_ALT] + "' src='" + instance.elemArray[bulletIndex][ELEM_THUMBNAIL] + "' style='display:block;position:absolute;left:0px;top:0px;" + style + "' /></div>");
                                $previewImages.append($curImg);
                                if ($prevImg.length > 0)
                                    $prevImg.animate({
                    ...
                    $(imgLoader).on("load", function() {
                        ...
                        if (instance.options.navthumbstyle != "textonly") {
                            ...
                            if (this.width / this.height <= instance.options.navimagewidth / instance.options.navimageheight)
                                style = "max-width:none !important;width:100%;height:auto;margin-top:-" + Math.floor(this.height / this.width * instance.options.navimagewidth / 2 - instance.options.navimageheight / 2) + "px";
                            else
                            ...
                            if (instance.options.navshowplayvideo && (instance.elemArray[index][ELEM_VIDEO].length > 0 || instance.elemArray[index][ELEM_LINK] && instance.elemArray[index][ELEM_LIGHTBOX] && instance.elemArray[index][ELEM_VIDEOTYPE] > 0))
                                $bullet.append("<div class='amazingslider-bullet-playvideo-" + instance.id + "' style='display:block;position:absolute;margin-left:0;margin-top:0;width:" + instance.options.navimagewidth + "px;height:" + instance.options.navimageheight + "px;" + 'background:url("' + instance.options.navplayvideoimage + '") no-repeat center center;' + "' ></div>")
                        }
                        if (instance.options.navthumbstyle != "imageonly") {
            ...
            slideRun: function(index, playVideo, transEffect) {
                ...
                if (savedCur == this.curElem)
                    return;
                if (savedCur >= 0)
                    this.container.removeClass("amazingslider-activeslide-" + this.id + "-" + savedCur);
                ...
                if ((playVideo || this.options.autoplayvideo) && this.elemArray[this.curElem][ELEM_VIDEO].length > 0)
                    this.playVideo(true);
                else if (!this.elemArray[this.curElem][ELEM_SRC] && this.elemArray[this.curElem][ELEM_VIDEO].length > 0)
                    this.playVideo(this.options.autoplayvideo);
                else {
            ...
            showImage: function(slideDirection, transEffect) {
                ...
                $(imgLoader).on("load", function() {
                    ...
                    imgCurCodes += "<img alt='" + instance.elemArray[instance.curElem][ELEM_ALT] + "' class='amazingslider-img-elem-" + instance.id + "' data-originalwidth='" + this.width + "' data-originalheight='" + this.height + "' style='position:absolute;" + (ASPlatforms.isIE678() ? "opacity:inherit;filter:inherit;" : "");
                    ...
                    if (Math.abs(instance.curImageMarginLeft) > 0)
                        ...
                        imgCurCodes += "max-width:" + instance.curImageMaxWidth + "%;width:" + instance.curImageMaxWidth + "%;height:auto;left:0%;top:0%;margin-top:" + instance.curImageMarginTop + "%;";
                    ...
                    if (transEffect && transEffect in instance.options)
                    ...
                    $box.amazingsliderTransition(instance.id, $imgPrev, $imgCur, {
                        ...
                        if (!instance.isPaused && !instance.videoPaused && instance.elemArray.length > 1)
        ...
        this.each(function() {
            ...
            if (this.options.textformat && typeof AMAZINGSLIDER_TEXT_EFFECT_FORMATS !== "undefined")
                if (this.options.textformat in AMAZINGSLIDER_TEXT_EFFECT_FORMATS)
                    this.options = $.extend({}, AMAZINGSLIDER_TEXT_EFFECT_FORMATS[this.options.textformat], this.options);
            if (this.options.textformat && this.options.customeffects)
                if (this.options.textformat in this.options.customeffects)
                    this.options = $.extend({}, this.options.customeffects[this.options.textformat], this.options);
            ...
            if (this.options.forcewidthtoevenforslice) {
                ...
                if ($.inArray("slice", effects) < 0)
                    this.options.forcewidthtoevenforslice = false
            }
            ...
            if (typeof AMAZINGSLIDER_TEXT_EFFECT_FORMATS !== "undefined") {
                ...
                if (this.options.customeffects)
                    this.options.textformat = $.extend({}, this.options.textformat, this.options.customeffects)
            }
...
(function($) {
    $.fn.amazingsliderTransition = function(id, $prev, $next, transition, callback, transitionStartCallback) {
        ...
        if ((effect == "threed" || effect == "threedwithzoom" || effect == "threedtiles" || effect == "threedhorizontal" || effect == "threedhorizontalwithzoom" || effect == "threedflip" || effect == "threedflipwithzoom") && !ASPlatforms.css33dTransformSupported())
            effect = transition[effect].fallback;
        if ((effect == "flip" || effect == "flipwithzoom" || effect == "tiles") && ASPlatforms.isIE6789())
            effect = transition[effect].fallback;
